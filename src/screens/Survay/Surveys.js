                    ...
                    <View style={styles.ExpiringContainer}>
                      <View
                        style={[
                          ...
                          {
                            backgroundColor:
                              data?.isSolved == "No" ? "#FFD6D6" : "#B0DBCC",
                          },
                        ]}
                      >
                        <Text style={styles.completeText}>
                          {data?.isSolved == "No" ? "Incomplete" : "Complete"}
                        </Text>
                      </View>
                      <View style={styles.ExpiringContainer}>
